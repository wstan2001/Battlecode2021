 ...
 */
public strictfp class EnemyPresent implements FlagMessage{
    ...
    public EnemyPresent(RelativeLocation relativeLocation, int influence, RobotType robotType, boolean trueSense){
    ...
    public EnemyPresent(int flagCode){
    ...
    public boolean equals(Object o) {
        ...
        EnemyPresent that = (EnemyPresent) o;
